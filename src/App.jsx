    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="mb-8">
            <div className="w-52 h-52 mx-auto mb-6 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 p-1.5 shadow-2xl">
              <img
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-8">
            ...
            <a href="https://docs.google.com/document/d/1eP5SvvBdKs8g12vHFDDGmZRdZZD6sdN8qxui5w3017k/edit" target="_blank" rel="noopener noreferrer" className="px-10 py-4 bg-slate-800/80 rounded-full hover:bg-slate-700 transition flex items-center gap-3 text-lg font-semibold border-2 border-purple-500/30">
              <Download size={22} />
              Download CV
            </a>
          </div>
      ...
      <section id="about" className="relative py-24 px-4 sm:px-6 bg-slate-900/70 backdrop-blur">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-5xl font-bold mb-16 text-center bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">About Me</h3>
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-purple-600/20 p-8 rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition">
                <Code size={32} className="text-purple-400 mb-3" />
                <div className="text-5xl font-bold text-purple-400 mb-2">10+</div>
                <div className="text-gray-300">Apps Built</div>
              </div>
              <div className="bg-pink-600/20 p-8 rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition">
                <Award size={32} className="text-pink-400 mb-3" />
                <div className="text-5xl font-bold text-pink-400 mb-2">2+</div>
                <div className="text-gray-300">Years Experience</div>
              </div>
              <div className="bg-yellow-600/20 p-8 rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition">
                <Star size={32} className="text-yellow-400 mb-3" />
                <div className="text-5xl font-bold text-yellow-400 mb-2">B.Sc</div>
                <div className="text-gray-300">Computer Science</div>
              </div>
              <div className="bg-green-600/20 p-8 rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition">
                ...
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="p-12 flex flex-col justify-center">
                    <div className="flex items-center gap-4 mb-6">
                      <img src={project.icon} alt={project.title} className="w-20 h-20 rounded-2xl shadow-lg" />
                      <div>
                        <h4 className="text-3xl font-bold mb-1">{project.title}</h4>
                    ...
                    <div className="mb-6">
                      <h5 className="text-xl font-semibold mb-3 text-purple-400">Key Features:</h5>
                    ...
                    <div className="flex flex-wrap gap-3 mb-8">
                      {project.tech.map((tech, i) => (
                        <span key={i} className="px-4 py-2 bg-purple-600/30 rounded-full text-sm border border-purple-500/30">
                          {tech}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                      <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-purple-500/20">
                        <div className="text-2xl font-bold text-purple-400">{project.stats.downloads}</div>
                        <div className="text-sm text-gray-400">Downloads</div>
                      </div>
                      <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-purple-500/20">
                        <div className="text-2xl font-bold text-pink-400">{project.stats.rating}</div>
                        <div className="text-sm text-gray-400">Rating</div>
                      </div>
                      <div className="text-center p-4 bg-slate-800/50 rounded-xl border border-purple-500/20">
                        <div className="text-2xl font-bold text-yellow-400">{project.stats.reviews}</div>
                    ...
                    <div className="flex gap-4 flex-wrap">
                      {project.playstore && (
                        <a href={project.playstore} target="_blank" rel="noopener noreferrer" className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl hover:from-purple-700 hover:to-pink-700 transition flex items-center justify-center gap-2 font-semibold shadow-lg">
                          <ExternalLink size={20} />
                          Play Store
                        </a>
                      )}
                      {project.appstore && (
                        <a href={project.appstore} target="_blank" rel="noopener noreferrer" className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl hover:from-purple-700 hover:to-pink-700 transition flex items-center justify-center gap-2 font-semibold shadow-lg">
                          <Apple size={20} />
                          App Store
                        </a>
                      )}
                      <a href={project.github} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-slate-800 rounded-xl hover:bg-slate-700 transition flex items-center gap-2 font-semibold border-2 border-purple-500/30">
                        <Github size={20} />
                        Code
                      </a>
                    </div>
                  ...
                  <div className="p-12 flex items-center justify-center bg-purple-900/20">
                        ...
                        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2 z-10">
                          {project.screenshots.map((_, i) => (
                            <button
                              ...
                              className={`w-2 h-2 rounded-full transition ${getCurrentScreenshot(index) === i ? 'bg-purple-400 w-6' : 'bg-gray-500 hover:bg-gray-400'}`}
                            />
                          ))}
                        </div>
                      </div>
      ...
      <section id="skills" className="relative py-24 px-4 sm:px-6 bg-slate-900/70 backdrop-blur">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-5xl font-bold mb-16 text-center bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Skills & Technologies</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skills.map((skillGroup, index) => (
              <div key={index} className="bg-purple-600/10 p-8 rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition">
      ...
      <section id="contact" className="relative py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Let's Work Together</h3>
          <p className="text-gray-300 text-xl mb-12">
            I'm available for freelance projects and full-time opportunities. Let's build something amazing!
          </p>
          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a href="mailto:youssifgamal123@gmail.com" className="px-8 py-6 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl hover:from-purple-700 hover:to-pink-700 transition flex items-center justify-center gap-3 text-lg font-semibold shadow-lg">
              <Mail size={24} />
              Email Me
            </a>
            <a href="tel:+201028823209" className="px-8 py-6 bg-slate-800/80 rounded-2xl hover:bg-slate-700 transition flex items-center justify-center gap-3 text-lg font-semibold border-2 border-purple-500/30">
              <Phone size={24} />
              Call Me
            </a>
            <a href="https://www.linkedin.com/in/yousef-gamal-5486aa237/" target="_blank" rel="noopener noreferrer" className="px-8 py-6 bg-slate-800/80 rounded-2xl hover:bg-slate-700 transition flex items-center justify-center gap-3 text-lg font-semibold border-2 border-purple-500/30">
              <Linkedin size={24} />
              LinkedIn
            </a>
            <a href="https://github.com/yousef123123123" target="_blank" rel="noopener noreferrer" className="px-8 py-6 bg-slate-800/80 rounded-2xl hover:bg-slate-700 transition flex items-center justify-center gap-3 text-lg font-semibold border-2 border-purple-500/30">
              <Github size={24} />
              GitHub
            </a>
          </div>
